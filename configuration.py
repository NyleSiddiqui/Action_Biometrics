...
def build_config(dataset):
    ...
    if dataset == 'ntu_rgbd_120':
        ...
        cfg.train_annotations = '/home/siddiqui/Action_Biometrics-RGB/data/NTUTrain_CVmap.csv'
        cfg.test_annotations = '/home/siddiqui/Action_Biometrics-RGB/data/NTUTest_CVmap.csv'
