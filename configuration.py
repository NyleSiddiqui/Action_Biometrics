...
def build_config(dataset):
    ...
    if dataset == 'ntu_rgbd_120':
        ...
        cfg.train_annotations = 'C://Users/ny525072/PycharmProjects/Multiview_Actions/PKUMMDTrainCS_map.csv'
        cfg.test_annotations = 'C://Users/ny525072/PycharmProjects/Multiview_Actions/PKUMMDTestCS_map.csv'
